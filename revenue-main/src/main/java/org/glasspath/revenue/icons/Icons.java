...
public class Icons {
	...
	static {
		...
		calculatorVariantOutlineContrast.setColorFilter(SvgIcon.CONTRAST_DARK);
		...
		carContrast.setColorFilter(SvgIcon.CONTRAST_DARK);
		...
		phoneInTalkContrast.setColorFilter(SvgIcon.CONTRAST_DARK);
		...
		receiptOutlineContrast.setColorFilter(SvgIcon.CONTRAST_DARK);
		...
		timerOutlineContrast.setColorFilter(SvgIcon.CONTRAST_DARK);
